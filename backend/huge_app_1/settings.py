"""
Django settings for huge_app_1 project.
...
WSGI_APPLICATION = 'huge_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "huge_app_1 API",
    "DESCRIPTION": "API documentation for huge_app_1 App",
    "VERSION": "v1",
}
